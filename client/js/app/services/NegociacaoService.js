        ...
        execute: function () {
            ...
            _export('NegociacaoService', NegociacaoService = function () {
                ...
                _createClass(NegociacaoService, [{
                    key: 'obterNegociacoesSemanais',
                    value: function obterNegociacoesSemanais() {
                        var _this = this;
                    ...
                    value: function obterNegociacoes() {
                        return Promise.all([this.obterNegociacoesSemanais(), this.obterNegociacoesSemanaAnterior(), this.obterNegociacoesSemanaRetrasada()]).then(function (periodos) {
                    ...
                    value: function importa(listaAtual) {
                        return this.obterNegociacoes().then(function (negociacoes) {
                            ...
                            console.log(erro);
                            throw new Error('Não foi possível buscar negociações para a importação.');
                        });
                    }
                }]);
